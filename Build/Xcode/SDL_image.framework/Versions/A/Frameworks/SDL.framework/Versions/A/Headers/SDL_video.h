...
#define SDL_TRIPLEBUF	0x40000000	/**< Set up double-buffered video mode */
 ...
 *
 * If SDL_TRIPLEBUF is set in 'flags', the SDL library will try to set up
 ...
 * The SDL_TRIPLEBUF flag must have been passed to SDL_SetVideoMode() when
